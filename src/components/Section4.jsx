...
const aboutPoints = [
  { title: "Our Vision", desc: "To drive innovation and empower communities through technology." },
  { title: "Our Mission", desc: "Deliver cutting-edge solutions that make a tangible impact on lives." },
  { title: "Our Values", desc: "Integrity, creativity, and sustainability guide everything we do." },
];
