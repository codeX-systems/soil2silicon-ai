...
//  return (
//    <div  className="relative md:absolute md:right-0 md:top-0 mt-12 md:mt-0 w-full md:w-[50%] lg:w-[520px] text-white p-6 z-10 flex flex-col justify-center items-center gap-4 bg-transparent">
...
//                 <h3 className="font-mono text-lg md:text-xl font-semibold text-white tracking-wide">QUANTUM_FARM.exe</h3>
...
//                   <motion.div
//                     key={index}
//                     className="bg-white/5 border border-white/10 p-3 md:p-4 lg:p-5rounded-xl text-center backdrop-blur-sm hover:border-[#00ffcc]/40 transition-all"
//                     whileHover={{ y: -4 }}
//                     data-interactive
//                   >
//                     <motion.div
//                       className="text-lg md:text-xl lg:text-2xl font-black mb-1 font-mono"
//                       style={{
...
//                       {metric.value}
//                     </motion.div>
//                     <div className="text-[11px] md:text-xs text-white/70 leading-snug font-medium">
//                       {metric.label}
//                     </div>
//                   </motion.div>
//                 ))}
...
const SoilToSiliconCard = () => {
  ...
  const metrics = [
    { value: "97.3%", label: t("soilcard_metric1") },
    { value: "5.2K", label: t("soilcard_metric2") },
    { value: "+47%", label: t("soilcard_metric3") },
  ];
    ...
    <div className="relative md:absolute md:right-0 md:top-0 mt-12 md:mt-0 w-full md:w-[50%] lg:w-[520px] text-white p-6 z-10 flex flex-col justify-center items-center gap-4 bg-transparent">
      ...
      >
        ...
        >
          ...
          {/* Header */}
          <div className="flex justify-between items-center mb-6 md:mb-8 lg:mb-10">
            <h3 className="font-mono text-lg md:text-xl font-semibold text-white tracking-wide">
              {t("soilcard_title")}
            </h3>
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-4 lg:gap-6 text-center mb-6 md:mb-8">
            {metrics.map((metric, index) => (
              <motion.div
                key={index}
                className="bg-white/5 border border-white/10 p-3 md:p-4 lg:p-5 rounded-xl backdrop-blur-sm hover:border-[#00ffcc]/40 transition-all"
                whileHover={{ y: -4 }}
              >
                <motion.div
                  className="text-lg md:text-xl lg:text-2xl font-black mb-1 font-mono"
