...
export default function OurSolutions() {
  ...
  const data = [
    {
      title: t("solutions_title1"),
      slides: [
        t("solutions_1_slide1"),
        t("solutions_1_slide2"),
        t("solutions_1_slide3"),
        t("solutions_1_slide4"),
      ],
    },
    {
      title: t("solutions_title2"),
      slides: [
        t("solutions_2_slide1"),
        t("solutions_2_slide2"),
        t("solutions_2_slide3"),
        t("solutions_2_slide4"),
      ],
    },
    {
      title: t("solutions_title3"),
      slides: [
        t("solutions_3_slide1"),
        t("solutions_3_slide2"),
        t("solutions_3_slide3"),
        t("solutions_3_slide4"),
      ],
    },
    {
      title: t("solutions_title4"),
      slides: [
        t("solutions_4_slide1"),
        t("solutions_4_slide2"),
        t("solutions_4_slide3"),
        t("solutions_4_slide4"),
      ],
    },
    {
      title: t("solutions_title5"),
      slides: [
        t("solutions_5_slide1"),
        t("solutions_5_slide2"),
        t("solutions_5_slide3"),
        t("solutions_5_slide4"),
      ],
    },
  ];
