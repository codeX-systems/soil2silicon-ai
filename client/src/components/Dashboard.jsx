...
//       {/* FIXED: Removed the wrapper div that caused the profile to flash. 
//           Inside your Header component, make sure you handle the profile click 
//           specifically on the user avatar, or pass setActiveModal down as a prop.
//       */}
//       <Header 
...
//         <FeatureContainer icon={<img src={grownew} className="w-10 h-10" />} title="Grow New" onClick={() => setActiveModal("grow")} />
//         <FeatureContainer icon={<img src={predict} className="w-10 h-10" />} title="Predict" onClick={() => setActiveModal("predict")} />
//         <FeatureContainer icon={<img src={weather} className="w-10 h-10" />} title="Weather" onClick={() => setActiveModal("weather")} />
//         <FeatureContainer icon={<img src={soil} className="w-10 h-10" />} title="Soil" onClick={() => setActiveModal("soil")} />
//         <FeatureContainer icon={<img src={trending} className="w-10 h-10" />} title="Trends" onClick={() => setActiveModal("trending")} />
//         <FeatureContainer icon={<img src={github} className="w-10 h-10" />} title="GitHub" onClick={() => window.open("https://github.com/codeX-systems24", "_blank")} />
//       </div>
...
//       {activeModal === "predict" && (
//         <ModalWrapper close={closeModal}>
//           <h2 className="text-xl font-bold text-green-700 mb-6 text-center">Predictive Yield</h2>
//           <div className="space-y-4">
//             <ModalSelect label="Soil Composition" options={["High Nitrogen", "High Potassium", "Balanced"]} />
//             <ModalSelect label="Season" options={["Kharif", "Rabi", "Zaid"]} />
//             <div className="p-4 bg-green-50 border border-dashed border-green-300 rounded-xl text-center italic text-sm text-green-700">
//                 AI will analyze current soil data against market trends for {user.district || 'your area'}.
//             </div>
//           </div>
//           <ModalButtons close={closeModal} action="Run Predictor" onAction={() => alert("Analyzing region data...")} />
//         </ModalWrapper>
//       )}
...
//   // --- NEW LOGIC: Calculate Harvest Progress for Multiple Crops ---
...
//       progress = Math.max(0, Math.min(100, Math.round(progress))); // Keep between 0 and 100
      
//       return { name: crop.crop_name, progress };
//     });

//     // Find the crop that is closest to 100% (ready soonest)
...
//       {/* UPDATED: Passing dynamic stats to Harvest component */}
//       <Harvest 
